...
@section('content')
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="storage/img/3.jpg" class="d-block w-100" alt="...">
                        </div>
        ...
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <p class="card-text">ООО «МРТС Терминал» оказывает комплексные логистические услуги по хранению и перевалке
    ...
    <div class="col">
         <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Инфраструктура ООО «МРТС Терминал» располагается в максимальной близости к автомобильной трассе М-8, в сравнении с
    ...
    <div class="col">
         <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <p class="card-text">В эксплуатации причалы № 118, 119, длина по 180 м, максимальная осадка 7,4 м. Имеется развитая система собственных
         ...
         <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <p class="card-text"><ul>
                ...
                <li>Площади хранения опасных грузов (3 кл. опасности) – 7 500 тн (селитра) / 30 000 тн (селитра в виде удобрений).
                </li>
            </ul></p>
          </div>
         </div>
