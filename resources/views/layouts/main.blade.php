...
<div class="container">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="/"><img src="storage/img/ico.png" alt="logo" width="180" ></a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link  {{ (request()->is('about')) ? 'active' : '' }}" aria-current="page" href="/about">О компании</a>
                        </li>
                        <li class="nav-item">
...
<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    <div class="col-md-4 d-flex align-items-center"> <a href="/"
            ...
            </svg> </a> <span class="mb-3 mb-md-0 text-body-secondary">© 2025 ООО "МРТС Терминал"</span> </div>
